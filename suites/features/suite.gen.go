...
func (s *Suite) TestExclude_prefixes() {
	...
	r.Run(`kubectl apply -k https://github.com/NikitaSkrynnik/deployments-k8s/examples/features/exclude-prefixes/configmap?ref=3201a2720b54a228a2fe248ee73a28c2755467b6`)
	r.Run(`kubectl apply -k https://github.com/NikitaSkrynnik/deployments-k8s/examples/features/exclude-prefixes?ref=3201a2720b54a228a2fe248ee73a28c2755467b6`)
