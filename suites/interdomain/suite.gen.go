...
func (s *Suite) TestNsm_consul() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_consul/server/counting_service.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_consul/server/counting.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_consul/netsvc.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-client` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_consul/nse-auto-scale-server`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_consul/service.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_consul/client/dashboard.yaml`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_consul/server/counting_nsm.yaml`)
...
func (s *Suite) TestNsm_istio() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_istio/netsvc.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_istio/greeting/client.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_istio/nse-auto-scale`)
...
func (s *Suite) TestNsm_kuma_universal_vl3() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_kuma_universal_vl3/vl3-dns` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n ns-dns-vl3 wait --for=condition=ready --timeout=5m pod -l app=vl3-ipam`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_kuma_universal_vl3/demo-redis.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG1 -n kuma-demo wait --for=condition=ready --timeout=5m pod -l app=redis`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/interdomain/nsm_kuma_universal_vl3/demo-app.yaml` + "\n" + `kubectl --kubeconfig=$KUBECONFIG2 -n kuma-demo wait --for=condition=ready --timeout=5m pod -l app=demo-app`)
