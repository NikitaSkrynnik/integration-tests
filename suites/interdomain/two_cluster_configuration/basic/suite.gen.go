...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/interdomain/two_cluster_configuration/basic/cluster1`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/interdomain/two_cluster_configuration/basic/cluster2`)
