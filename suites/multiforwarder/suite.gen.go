...
func (s *Suite) TestKernel2Ethernet2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2Noop`)
...
func (s *Suite) TestKernel2Kernel_Vfio2Noop() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2Noop`)
...
func (s *Suite) TestSriovKernel2Noop() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger`)
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/SriovKernel2Noop`)
...
func (s *Suite) TestVfio2Noop() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Vfio2Noop`)
