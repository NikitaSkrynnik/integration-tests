...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/observability/jaeger_and_prometheus`)
	r.Run(`kubectl wait -n observability --timeout=1m --for=condition=ready pod -l app=opentelemetry`)
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/observability/jaeger_and_prometheus/example`)
