...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/multiforwarder`)
...
func (s *Suite) TestKernel2ethernet2kernel_vfio2noopvlantag() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2NoopVlanTag`)
...
func (s *Suite) TestKernel2kernel_vfio2noopvlantag() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/use-cases/Kernel2Kernel_Vfio2NoopVlanTag`)
...
func (s *Suite) TestSriovkernel2noopvlantag() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/use-cases/SriovKernel2NoopVlanTag/ponger`)
	...
	r.Run(`kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/use-cases/SriovKernel2NoopVlanTag`)
...
func (s *Suite) TestVfio2noopvlantag() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/use-cases/Vfio2NoopVlanTag`)
