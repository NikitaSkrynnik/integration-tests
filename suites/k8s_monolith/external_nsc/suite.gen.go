...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/k8s_monolith/configuration/cluster`)
...
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../../../home/nikita/repos/NSM/deployments-k8s/examples/k8s_monolith/external_nsc/usecases/Kernel2IP2Kernel`)
