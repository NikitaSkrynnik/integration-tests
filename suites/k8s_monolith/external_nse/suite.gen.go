...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/k8s_monolith/configuration/cluster`)
...
func (s *Suite) TestKernel2IP2Kernel() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/k8s_monolith/external_nse/usecases/Kernel2IP2Kernel`)
