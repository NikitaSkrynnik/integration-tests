...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/remotevlan_vpp`)
...
func (s *Suite) TestKernel2RVlanBreakout() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/Kernel2RVlanBreakout`)
...
func (s *Suite) TestKernel2RVlanInternal() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/Kernel2RVlanInternal`)
...
func (s *Suite) TestKernel2RVlanMultiNS() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1`)
	r.Run(`kubectl apply -f ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2/ns-kernel2vlan-multins-2.yaml` + "\n" + `kubectl apply -f ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2/netsvc.yaml` + "\n" + `kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2`)
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-3`)
