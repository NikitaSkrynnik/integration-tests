...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../Users/user/repos/deployments-k8s/examples/ovs`)
...
func (s *Suite) TestWebhook_smartvf() {
	...
	r.Run(`WH=$(kubectl get pods -l app=admission-webhook-k8s -n nsm-system --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}')` + "\n" + `kubectl wait --for=condition=ready --timeout=1m pod ${WH} -n nsm-system`)
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/features/webhook-smartvf`)
...
func (s *Suite) TestKernel2KernelVLAN() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2KernelVLAN`)
...
func (s *Suite) TestSmartVF2SmartVF() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/SmartVF2SmartVF`)
