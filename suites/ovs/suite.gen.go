...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/ovs`)
...
func (s *Suite) TestKernel2KernelVLAN() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/Kernel2KernelVLAN`)
...
func (s *Suite) TestSmartVF2SmartVF() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/use-cases/SmartVF2SmartVF`)
