...
func (s *Suite) SetupSuite() {
	...
	r.Run(`kubectl apply -k ../../../../../../../Users/user/repos/deployments-k8s/examples/remotevlan_ovs`)
...
func (s *Suite) TestKernel2RVlanBreakout() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2RVlanBreakout`)
...
func (s *Suite) TestKernel2RVlanInternal() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2RVlanInternal`)
...
func (s *Suite) TestKernel2RVlanMultiNS() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1`)
	r.Run(`kubectl apply -f ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2/ns-kernel2vlan-multins-2.yaml` + "\n" + `kubectl apply -f ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2/netsvc.yaml` + "\n" + `kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2`)
	r.Run(`kubectl apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-3`)
	...
	r.Run(`status=0` + "\n" + `for nsc in "${NSCS_GREEN[@]}"` + "\n" + `do` + "\n" + `  docker exec rvm-tester ping -c 1 ${IP_ADDR_GREEN[$nsc]} -I eth0.300` + "\n" + `  if test $? -ne 0` + "\n" + `    then` + "\n" + `      status=1` + "\n" + `  fi` + "\n" + `done` + "\n" + `if test ${status} -eq 1` + "\n" + `  then` + "\n" + `    false` + "\n" + `fi`)
	r.Run(`NSCS=($(kubectl get pods -l app=alpine-4 -nns-kernel2vlan-multins-3 --template '{{range .items}}{{.metadata.name}}{{"\n"}}{{end}}'))`)
