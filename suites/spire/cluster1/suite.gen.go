...
func (s *Suite) SetupSuite() {
	...
	r.Run(`[[ ! -z $KUBECONFIG1 ]]`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -k ../../../../../../../../Users/user/repos/deployments-k8s/examples/spire/cluster1`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../../../../../Users/user/repos/deployments-k8s/examples/spire/cluster1/clusterspiffeid-template.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG1 apply -f ../../../../../../../../Users/user/repos/deployments-k8s/examples/spire/base/clusterspiffeid-webhook-template.yaml`)
}
func (s *Suite) Test() {}
