...
func (s *Suite) SetupSuite() {
	...
	r.Run(`[[ ! -z $KUBECONFIG2 ]]`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/spire/cluster2`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/spire/cluster2/clusterspiffeid-template.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG2 apply -f ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/spire/base/clusterspiffeid-webhook-template.yaml`)
}
func (s *Suite) Test() {}
