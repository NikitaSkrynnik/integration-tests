...
func (s *Suite) SetupSuite() {
	...
	r.Run(`[[ ! -z $KUBECONFIG3 ]]`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -k ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/spire/cluster3`)
	...
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -f ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/spire/cluster3/clusterspiffeid-template.yaml`)
	r.Run(`kubectl --kubeconfig=$KUBECONFIG3 apply -f ../../../../../../../../../Users/user/repos/NSM/deployments-k8s/examples/spire/base/clusterspiffeid-webhook-template.yaml`)
}
func (s *Suite) Test() {}
